                ...
                <div className="flex-1 overflow-y-auto hide-scrollbar -mx-4 sm:-mx-6 lg:-mx-8">
                    <div className="px-4 sm:px-6 lg:px-8 pb-8">
                        ...
                        >
                            ...
                            <form id="feedback-form" onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">

                                {/* Name */}
                                <div>
                                    <label htmlFor="fullName" className="block text-slate-400 mb-2 text-sm">Имя</label>
                                    <Input id="fullName" {...register('fullName')} type="text" placeholder="Адам Смэшер" variant="form"/>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 p-2.5   bg-slate-900/50 text-slate-200 rounded-full border-2 border-slate-800 shadow-inner ">
                                        {/* Height */}
                                        <div className="text-center">
                                            <div className="flex items-center justify-center ">
                                                <Button type="button" onClick={() => adjustValue('height', -1)} variant="ghost" size="sm" className="w-8">-</Button>
                                        ...
                                        <div className="text-center">
                                            <div className="flex items-center justify-center">
                                                <Button type="button" onClick={() => adjustValue('weight', -1)} variant="ghost" size="sm" className="w-8">-</Button>
                                        ...
                                        <div className="text-center">
                                            <div className="flex items-center justify-center">
                                                <Button type="button" onClick={toggleGender} variant="ghost" size="sm" className="w-8">-</Button>
                                ...
                                <div>
                                    ...
                                    <Input id="city" {...register('city')} type="text" placeholder="Найт-Сити" variant="form"/>
